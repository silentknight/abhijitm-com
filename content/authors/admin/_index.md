...
My research interests lie primarily in Natural Language Processing (NLP), specializing in Large Language Models (LLMs). I am pursuing my research under the guidance of Prof. John D. Kelleher at Technological University Dublin, Ireland, co-funded by TU Dublin Research Award and a research grant by ADAPT Centre, Ireland. I was previously funded by an IBM shared university grant. My research lies at the intersection of Deep Learning, Natural Language Processing, Linguistics, and Information Theory. I examine the impact of long distance dependency in a dataset on language models in an attempt to make them more efficient.
